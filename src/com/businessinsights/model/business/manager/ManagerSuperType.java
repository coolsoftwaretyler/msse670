...
import com.businessinsights.model.business.exception.PropertyFileNotFoundException;
import com.businessinsights.model.services.manager.PropertyManager;
...
public abstract class ManagerSuperType {
		 ...
		 * What we hope to achieve in this application is that when the InsightManager(which extends this class)
		...
		/**
		 * Loads the property file into memory, so it's available for use by all tiers (business and below)
	    ...
	    public static void loadProperties () throws PropertyFileNotFoundException
		{
			...
			*   <property key="prop_location" value="${prop.dir}application.properties"/>
	    	*
